...
const Header = () => {
  ...
  checkAuth()
    ...
    .catch(() => {
      const publicPages = ["/", "/home", "/login", "/signup", "/workersignup", "/clientsignup", "/forgetpass", "/workerquestion"];
  ...
  return (
    ...
    <header className="w-full z-20 top-0 start-0 pt-4 fixed top-0 bg-[#f4f6f6]">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto pt-4 p-2">
        <Link to={user ? "/find-work" : "/home"} className="flex items-center space-x-3 rtl:space-x-reverse">
              ...
              {showAuthButtons ? (
                ...
                <>
                  ...
                  <div className="w-25 pt-1 md:pt-0 md:w-43 flex flex-row gap-5 md:gap-2 hidden md:flex">
                    ...
                    {showNotifications && (
                      <div ref={notificationRef} className="absolute right-30 mt-10 w-64 bg-white shadow-lg rounded-md border border-gray-200 z-100">
