    ...
    return (
        <>
            ...
            <aside
                ref={sidebarRef}
                id="default-sidebar"
                className={`absolute top-55 md:top-48 left-0 z-40 w-full md:w-65 h-134 transition-transform bg-white md:bg-[#f4f6f6] md:opacity-100 opacity-98 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
                            ...
                            return (
                                <li>
                                    <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-dark hover:bg-[#f0f0f0] hover:shadow-sm group">
                                        ...
                                        <span className={`inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium rounded-full bg-blue-800 text-blue-300 ${cont.inbox ? '' : 'hidden'} `} >{cont.inbox ? cont.inbox : null}</span>
                                    </a>
                                </li>
                            )
                        })}
                        ...
                        {messages.map((msg, index) => (
                            <div key={index} className={`flex items-start gap-2.5 mb-4 relative ${msg.sender === 'me' ? 'justify-end text-left' : ''}`}>
                                <div className="flex flex-col gap-1 w-full max-w-[320px]">
                                    ...
                                    <span className="text-sm font-normal text-gray-500 dark:text-gray-400 text-left">{msg.status}</span>
                                </div>
                        ...
                        <form className="flex items-center w-full">
                            <div className="relative flex-1">
                                <input
                                    type="text"
                                    id="simple-search"
                                    className="bg-gray-50 text-gray-900 text-sm block w-full ps-4 p-2.5 text-[16px] rounded-[20px] focus:ring-1 focus:outline-none focus:ring-gray-300"
