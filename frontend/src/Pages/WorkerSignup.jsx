...
const WorkerSignup = () => {
    ...
    const [showPasswordStrength, setShowPasswordStrength] = useState(false); // Track button click
    ...
    return (
        <>
            <form onSubmit={handleCreateAccount} className="max-w-lg md:max-w-2xl lg:max-w-3xl mx-auto mt-30 p-6 bg-white shadow-md rounded-lg">
                ...
                <div className="mb-6">
                    <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 text-left">Work Email address</label>
                    <input
                        type="email"
                        id="email"
